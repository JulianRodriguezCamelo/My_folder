        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            ...
            <span className="text-sm font-bold tracking-tight text-white">
              Julian<span className="text-violet-400">.</span>
            </span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Button
              size="sm"
              asChild
              className="rounded-full bg-white/5 border border-white/10 hover:border-violet-400/40 hover:bg-violet-500/15 hover:text-violet-200 text-white/70 font-semibold backdrop-blur-sm transition-all duration-300 px-5"
            >
          ...
          >
            ...
            <div className="relative px-8 pb-10">
              <Button
                size="lg"
                asChild
                className="w-full rounded-full bg-white/5 border border-white/10 hover:border-violet-400/40 hover:bg-violet-500/15 hover:text-violet-200 text-white/70 font-bold text-base backdrop-blur-sm transition-all duration-300"
              >
